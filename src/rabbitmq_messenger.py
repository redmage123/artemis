...
class RabbitMQMessenger(MessengerInterface):
    ...
    def __init__(
        ...
        self._core = RabbitMQMessengerCore(
        ...
        # Expose agent_name for backward compatibility
    ...
    def read_messages(
        ...
        return self._core.read_messages(
            message_type=message_type,
    ...
    def send_data_update(
        ...
        """Send data update"""
        return self._core.send_data_update(
            to_agent=to_agent,
            card_id=card_id,
    ...
    def send_notification(
        ...
        """Send notification"""
        return self._core.send_notification(
            to_agent=to_agent,
            card_id=card_id,
