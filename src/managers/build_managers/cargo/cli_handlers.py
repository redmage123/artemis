...
# Type hint for CargoManager (to avoid circular import)
...
def run_cli() -> None:
    ...
    parser.add_argument(
        "command",
        choices=["info", "build", "test", "check", "clippy", "fmt", "clean", "add"],
    ...
    try:
        ...
        # Call handler with appropriate arguments (guard clause for info command)
