...
class KnowledgeGraph:
    ...
    def add_function(
        ...
        return self._graph_ops.add_function(
            name, file_path, class_name, params, returns, public, complexity
        )
    ...
    def add_code_review(
        ...
        return self._graph_ops.add_code_review(
            review_id, card_id, status, score, critical_issues, high_issues
        )
    ...
    # ==================== RELATIONSHIP CREATION (Delegated) ====================
