...
class VectorStore:
    ...
    def __init__(
        ...
        # Guard: Warn if ChromaDB unavailable
    ...
    def _initialize_collections(self) -> Dict[str, Any]:
        ...
        for artifact_type in ARTIFACT_TYPES:
            collections[artifact_type] = self.client.get_or_create_collection(
                name=artifact_type,
    ...
    def add_artifact(
        ...
        """
        # Guard: Check if artifact type exists
